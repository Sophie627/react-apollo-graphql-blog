        ...
        {({ data, loading, error }) => {
          ...
          return (
            ...
            <div className={userWrapperClass}>
              <div className={photo}>
                <img src={data.getUser.profileImage ? data.getUser.profileImage : defaultAvatar} className={classes.avatarImg} alt="..." />
              </div>
              <List className={classes.list}>
                <ListItem className={classes.item + " " + classes.userItem}>
                  ...
                  >
                    <ListItemText
                      primary={data.getUser.firstName + " " + data.getUser.lastName}
                      secondary={
                        <b
                          className={
                            caret +
