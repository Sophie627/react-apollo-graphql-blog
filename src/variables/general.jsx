...
const dataTable = {
  headerRow: ["Checkbox","Name", "Position", "Office", "Age", "Actions"],
  footerRow: ["Checkbox","Name", "Position", "Office", "Age", "Actions"],
  dataRows: [
    [<Checkbox/>,"Tiger Nixon", "System Architect", "Edinburgh", "61"],
    [<Checkbox/>,"Garrett Winters", "Accountant", "Tokyo", "63"],
    [<Checkbox/>,"Ashton Cox", "Junior Technical Author", "San Francisco", "66"],
    [<Checkbox/>,"Cedric Kelly", "Senior Javascript Developer", "Edinburgh", "22"],
    [<Checkbox/>,"Airi Satou", "Accountant", "Tokyo", "33"],
    [<Checkbox/>,"Brielle Williamson", "Integration Specialist", "New York", "61"],
    [<Checkbox/>,"Herrod Chandler", "Sales Assistant", "San Francisco", "59"],
    [<Checkbox/>,"Rhona Davidson", "Integration Specialist", "Tokyo", "55"],
    [<Checkbox/>,"Colleen Hurst", "Javascript Developer", "San Francisco", "39"],
    [<Checkbox/>,"Sonya Frost", "Software Engineer", "Edinburgh", "23"],
    [<Checkbox/>,"Jena Gaines", "Office Manager", "London", "30"],
    [<Checkbox/>,"Quinn Flynn", "Support Lead", "Edinburgh", "22"],
    [<Checkbox/>,"Charde Marshall", "Regional Director", "San Francisco", "36"],
    [<Checkbox/>,"Haley Kennedy", "Senior Marketing Designer", "London", "43"],
    [<Checkbox/>,"Tatyana Fitzpatrick", "Regional Director", "London", "19"],
    [<Checkbox/>,"Michael Silva", "Marketing Designer", "London", "66"],
    [<Checkbox/>,"Paul Byrd", "Chief Financial Officer (CFO)", "New York", "64"],
    [<Checkbox/>,"Gloria Little", "Systems Administrator", "New York", "59"],
    [<Checkbox/>,"Bradley Greer", "Software Engineer", "London", "41"],
    [<Checkbox/>,"Dai Rios", "Personnel Lead", "Edinburgh", "35"],
    [<Checkbox/>,"Jenette Caldwell", "Development Lead", "New York", "30"],
    [<Checkbox/>,"Yuri Berry", "Chief Marketing Officer (CMO)", "New York", "40"],
    [<Checkbox/>,"Caesar Vance", "Pre-Sales Support", "New York", "21"],
    [<Checkbox/>,"Doris Wilder", "Sales Assistant", "Sidney", "23"],
    [<Checkbox/>,"Angelica Ramos", "Chief Executive Officer (CEO)", "London", "47"],
    [<Checkbox/>,"Gavin Joyce", "Developer", "Edinburgh", "42"],
    [<Checkbox/>,"Jennifer Chang", "Regional Director", "Singapore", "28"],
    [<Checkbox/>,"Brenden Wagner", "Software Engineer", "San Francisco", "28"],
    [<Checkbox/>,"Fiona Green", "Chief Operating Officer (COO)", "San Francisco", "48"],
    [<Checkbox/>,"Shou Itou", "Regional Marketing", "Tokyo", "20"],
    [<Checkbox/>,"Michelle House", "Integration Specialist", "Sidney", "37"],
    [<Checkbox/>,"Suki Burks", "Developer", "London", "53"],
    [<Checkbox/>,"Prescott Bartlett", "Technical Author", "London", "27"],
    [<Checkbox/>,"Gavin Cortez", "Team Leader", "San Francisco", "22"],
    [<Checkbox/>,"Martena Mccray", "Post-Sales support", "Edinburgh", "46"],
    [<Checkbox/>,"Unity Butler", "Marketing Designer", "San Francisco", "47"],
    [<Checkbox/>,"Howard Hatfield", "Office Manager", "San Francisco", "51"],
    [<Checkbox/>,"Hope Fuentes", "Secretary", "San Francisco", "41"],
    [<Checkbox/>,"Vivian Harrell", "Financial Controller", "San Francisco", "62"],
    [<Checkbox/>,"Timothy Mooney", "Office Manager", "London", "37"],
    [<Checkbox/>,"Jackson Bradshaw", "Director", "New York", "65"],
    [<Checkbox/>,"Olivia Liang", "Support Engineer", "Singapore", "64"]
  ]
};
